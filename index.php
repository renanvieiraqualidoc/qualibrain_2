...
<!-- Ruptura Curva B Modal-->

  <div class="modal fade" id="rupturabmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel1">Ruptura Curva B</h5>
...
$consultatotalprodutosrupturab1 = "SELECT Products.sku, Products.title, Products.department, Products.category, Products.price_cost, Products.sale_price, Products.current_price_pay_only,
 Products.current_less_price_around, Products.lowest_price_competitor, Products.current_gross_margin_percent, Products.diff_current_pay_only_lowest, Products.curve,
 marca.marca, marca.fabricante, Products.qty_competitors from Products Inner join marca on marca.sku=Products.sku where active='1'
...
echo  '<td>'.$rowrb1[7].'</td>';
echo  '<td>'.$rowrb1[8].'</td>';
echo  '<td>'.round((float)$rowrb1[9] * 100).'%</td>';
echo  '<td>'.round((float)$rowrb1[10] * 100).'%</td>';
echo  '<td>'.$rowrb1[11].'</td>';

echo  '<td>'.$rowrb1[12].'</td>';
echo  '<td>'.$rowrb1[13].'</td>';
...
var data1 = {
  ...
  datasets: [{
    ...
    label: "PAGUEMENOS",
    backgroundColor: "purple",
    data: [cfpague, cfpague5, cfpague10, cfpague20, cfpague30, cfpague30a]
}, {
