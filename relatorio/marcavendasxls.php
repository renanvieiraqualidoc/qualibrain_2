...
$sql= "Select marca.marca as MARCA, sum(vendas.qtd) as VENDA_ACUMULADA from marca inner join vendas on vendas.sku=marca.sku inner join Products on
...
//browser to download.
$filename = 'Total_Produtos_Marcas_Vendas.xls';
