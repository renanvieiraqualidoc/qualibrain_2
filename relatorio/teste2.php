...
$sql="SELECT vendas.sku, Products.title, SUM(vendas.qtd) as Vendas, Products.category, Products.department,
...
inner join Products on Products.sku = vendas.sku inner join marca on marca.sku=vendas.sku where data='2021-02-09'  group by sku";
