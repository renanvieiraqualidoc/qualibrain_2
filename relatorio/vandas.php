...
$sql="SELECT vendas.sku, Products.title, SUM(vendas.qtd * (data between '2021-01-31' and '2021-02-06' as 'SEMANA=1')),  
SUM(vendas.qtd * (data between '2021-02-13' and '2021-02-07' as 'SEMANA-2')), 
Products.qty_stock_rms as 'ESTOQUE', REPLACE(Products.price_cost, '.',',') as CUSTO, marca.marca as MARCA, marca.fabricante as FABRICANTE from vendas
inner join Products on Products.sku = vendas.sku inner join marca on marca.sku=vendas.sku  group by sku";
