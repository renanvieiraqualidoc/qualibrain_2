...
error_reporting(E_ALL);
 ...
 $sql= "select vendas.sku, Products.title, vendas.data, sum(vendas.qtd) from vendas inner join Products where vendas.data = '2021-02-03' 
and Products.title like '%repelente%' group by sku";
