...
$sql= "Select vendas.sku as SKU, sum(vendas.qtd) as Vendas,  Products.reference_code as EAN, Products.title as NOME,
...
marca.marca as MARCA, marca.fabricante as FABRICANTE, Products.otc as OTC, Products.descontinuado,
...
//browser to download.
$filename = 'Total_Produtos_ruptura.xls';
