...
error_reporting(E_ALL);
 ...
 $sql="Select marca.marca, avg(Products.current_gross_margin_percent),
avg(Products.diff_current_pay_only_lowest), sum(vendas.qtd) 
from Products inner join marca on Products.sku = marca.sku inner join vendas on vendas.sku=Products.sku
where Products.active=1 and Products.descontinuado<>1 group by marca";
$stmt = $pdo->query($sql);
